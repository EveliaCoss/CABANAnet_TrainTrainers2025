...
-   ::: {.panel-tabset group="globalInfo"}
    ...
    -   **Evelia Coss** - Postdoctoral LIIGH-UNAM, VieRnes de Bioinformática en el LIIGH-UNAM, RSG México y Rladies Morelia. Instructora certificada de Carpentries.  [Web page](https://eveliacoss.github.io/), **ecoss\@liigh.unam.mx**
    -   **Miguel Angel Magaña Lemus -** Tecnico CCM-UNAM, Instructor certificado de Carpentries, **miguel\@matmor.unam.mx**
    -   **Domingo Martinez -** Postdoctoral LIIGH-UNAM, Profesor de Asignatura ENES-UNAM, **ldmv82\@gmail.com**
    ...
    **Dia 2**
    ...
    | -   Introducción y recapitulación                      | 30 min     |
    +--------------------------------------------------------+------------+
    | -   Planificación de cursos                            | 40 min     |
    +--------------------------------------------------------+------------+
    | -   Definiendo tu audiencia y tus resultados esperados | 20 min     |
    +--------------------------------------------------------+------------+
    | ☕ *Coffee break (10:30 - 11:00) ☕*                   | 30 min     |
    +--------------------------------------------------------+------------+
    ...
    +--------------------------------------------------------+------------+
    | -   Simulación de entrenamiento 1 (en grupos)          | 30 min     |
    +--------------------------------------------------------+------------+
